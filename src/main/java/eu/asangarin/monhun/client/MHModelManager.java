...
public class MHModelManager {
	...
	public static void register() {
		...
		for (MHGatheringType type : MHGatheringType.values()) {
			registerOre(type);
			oreItemModel.addPredicate("ore_type", type.getValue(), "block/ore_" + type.asString());
		}
		...
		ModelPredicateProviderRegistrySpecificAccessor.callRegister(MHBlocks.ORE_BLOCK_ITEM, MonHun.i("ore_type"),
				(itemStack, clientWorld, livingEntity, ticks) -> MHGatheringType.fromStack(itemStack).getValue());
	}
